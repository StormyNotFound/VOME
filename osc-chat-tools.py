...
#Deprecated Variables. will remove as old save files were removed.
...
isAfk = False
isVR = False #Never used as the game never actually updates vrmode (well, it does *sometimes*) hmm.. strange...
isMute = False
isInSeat = False
voiceVolume = 0
